...
public class Contract
{
    ...
    public Contract(int id, DateTime dateFrom, DateTime dateTo, ContractStatus status, decimal price,
        DateTime updatesTo, int clientId, int softwareId, int softwareVersionId)
    {
        Id = id;
        DateFrom = dateFrom;
        DateTo = dateTo;
    ...
    public Contract(DateTime dateFrom, DateTime dateTo, ContractStatus status, decimal price, DateTime updatesTo,
        int clientId, int softwareId, int softwareVersionId)
    {
        DateFrom = dateFrom;
        DateTo = dateTo;
        Status = status;
    ...
    [Required] public DateTime UpdatesTo { get; set; }
    ...
    [ForeignKey("SoftwareVersionId")] public virtual SoftwareVersion SoftwareVersion { get; set; }
}